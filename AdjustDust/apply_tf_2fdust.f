...
c  UNC Chapel Hill
c  Center for Environmental Modeling for Policy Development
c  Program:  apply_tf_2fdust.f
c  Author: Mohammad Omary
c  Description: Program to apply gridded dust transport factors to dust emissions
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      use M3UTILIO
      implicit none 
...
c        LOGICAL         SETENVVAR
c
c        EXTERNAL   GETFLINE, STR2REAL,
c     &             BLKORCMT, ENVINT, INDEX1,SETENVVAR 
